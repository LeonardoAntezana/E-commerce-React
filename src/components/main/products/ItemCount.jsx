...
function ItemCount( {stock, initial, onAdd} ) {
  ...
  return (
    <div className='item-count p-3 rounded-3 d-flex flex-column align-items-center gap-3'>
        <div className='w-100 p-2 bg-light rounded-3 d-flex justify-content-around'>
          <button onClick={() => {cont > 1 ?setCont(cont - 1) : setCont(1)}} className='button-op rounded-3 d-flex align-items-center'><FaMinus/></button>
          <span id='contador' className=''>{cont}</span>
